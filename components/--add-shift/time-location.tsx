...
export default function TimeLocation({
  ...
  console.log("----------- Data List ----------", shiftTypeArrays);
  return (
    <StyledPaper>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select
                    ...
                    onChange={(event) => {
                      field.onChange(event.target.value); // Sync form value
                      console.log("Selected shift:", event.target.value); // Log selected value
                    }}
                  >
                    {shiftTypeArrays.map((_shift) => (
                      <MenuItem value={_shift.id} key={_shift.id}>
